...
from users.throttling import UserActionThrottle, RegisterRateThrottle
from users.services.user_management_services import UserManagementService
...
class UserManagementViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        ...
        - create: IsAuthenticated (authenticated users only)
    ...
    def get_throttles(self):
        ...
        - create: RegisterRateThrottle ('register' scope)
    ...
    def create(self, request, *args, **kwargs):
        """
        Register a new user account (must be logged in).
    ...
    def set_superuser_status(self, request, pk=None):
        ...
        if not request.user.is_superuser:
            raise PermissionDenied("Only superusers can modify superuser status.")
    ...
    def manage_groups(self, request, pk=None):
        ...
        """
        if not request.user.is_superuser:
            raise PermissionDenied("Only superusers can modify user groups.")
    ...
    def manage_permissions(self, request, pk=None):
        ...
        """
        if not request.user.is_superuser:
            raise PermissionDenied("Only superusers can modify user permissions.")
