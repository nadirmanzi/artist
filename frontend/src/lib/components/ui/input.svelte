<script lang="ts" module>
	...
	export const inputVariants = tv({
		slots: {
			...
			label:
				' font-medium text-sm group-focus-within:font-medium tracking-wide text-foreground transition-all duration-200 group-focus-within:text-foreground',
		...
		variants: {
			context: {
				...
				dark: {
					wrapper:
						'bg-white/10! border-1 border-white/20! rounded-full hover:bg-white/10! focus-within:bg-white/10! focus-within:border-nav-foreground/20!',
