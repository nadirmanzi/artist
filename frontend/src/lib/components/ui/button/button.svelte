<script lang="ts">
	...
	export const buttonVariants = tv({
		...
		variants: {
			...
			size: {
				...
				lg: 'h-11 px-5 text-base gap-2.5 min-w-24 [&_svg]:size-5.5',
		...
		compoundVariants: [
			...
			// SECONDARY OUTLINE
			{
				color: 'secondary',
				variant: 'outline',
				class: 'border-secondary/70 text-secondary hover:bg-secondary-hover/10 ease-in-out '
			},
			...
			},
			{
				color: 'black',
				variant: 'tonal',
				class: 'bg-nav-bg/10 text-foreground hover:bg-nav-bg/20 active:bg-nav-bg/20'
			},
			{
				color: 'black',
				variant: 'outline',
			...
			},
			{
				color: 'black',
				variant: 'ghost',
				class: 'text-foreground hover:bg-foreground/10 active:bg-foreground/10'
			},
			// WHITE (for dark backgrounds)
			{
				color: 'white',
				variant: 'filled',
				class: 'bg-surface text-foreground hover:bg-surface-hover active:bg-surface-hover'
			},
			{
				color: 'white',
				variant: 'tonal',
				class: 'bg-surface/20 text-surface hover:bg-surface/30 active:bg-surface/30'
			},
			{
				color: 'white',
				variant: 'outline',
				class: 'border-surface/50 text-surface hover:bg-surface/10'
			},
			{
				color: 'white',
				variant: 'ghost',
				class: 'text-surface hover:bg-surface/10'
			},
	...
	function getRippleColor(): string {
		if (variant === 'filled') {
			if (color === 'white') return 'rgba(0, 0, 0, 0.15)';
